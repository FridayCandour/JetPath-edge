...
export declare let _JetPath_paths: Record<methods, Record<string, (ctx: AppCTX) => void | Promise<void>>>;
export declare const _JetPath_hooks: Record<string, (ctx: AppCTX) => void | Promise<void>>;
export declare const _JetPath_app_config: {
    cors: (ctx: AppCTX) => void;
    set(this: any, opt: string, val: any): void;
};
export declare function getHandlers(source: ((ctx: AppCTX) => void)[]): Promise<void>;
